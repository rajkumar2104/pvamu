    ...
    $stateProvider
        ...
        .state('about', {
            ...
            views: {
                ...
                'columnTwo@about': { 
                    templateUrl: 'client/application/table-data.html',
...
//                           		private String employeeId;
                          ...
                          // 	 var promise = HpIncHttpService.getHttpPostConnection("http://pvamu-onlinetimesheet.rhcloud.com/TimeSheet/client/employee/save/expences" , expences);
                           		
                            	 var promise = HpIncHttpService.getHttpPostConnection(host +"TimeSheet/client/employee/save/expences" , expences);
...
//                           		private String employeeId;
                           	 ...
                           	 //var promise = HpIncHttpService.getHttpPostConnection("http://pvamu-onlinetimesheet.rhcloud.com/TimeSheet/client/employee/save/timesheet" , timeSheet);
                           		var promise = HpIncHttpService.getHttpPostConnection(host +"TimeSheet/client/employee/save/timesheet" , timeSheet);
                         ...
                         $scope.dataTimeSheet= function(){
                        	// var promise = HpIncHttpService.getHttpGetConnection("http://pvamu-onlinetimesheet.rhcloud.com/TimeSheet/client/employee/get/allTimesheet/"+$scope.employeeName);
                        	 var promise = HpIncHttpService.getHttpGetConnection(host +"TimeSheet/client/employee/get/allTimesheet/"+$scope.employeeName);
