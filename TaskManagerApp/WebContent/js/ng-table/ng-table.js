...
angular.module('ngTable').run(['$templateCache', function ($templateCache) {
	$templateCache.put('ng-table/filters/select-multiple.html', '<label class="hidden" for="{{column.filterName}}">{{column.filterName}}</label><select ng-options="data.id as data.title for data in column.data" multiple ng-multiple="true" ng-model="params.filter()[name]" ng-show="filter==\'select-multiple\'" class="filter filter-select-multiple form-control" name="{{column.filterName}}" id="{{column.filterName}}"> </select>');
	...
	$templateCache.put('ng-table/filters/text.html', '<label for="filterName" class="hidden">Queue Filter</label><input type="text" name="{{column.filterName}}" id="filterName" ng-model="params.filter()[name]" ng-if="filter==\'text\'" class="input-filter form-control"/>');
